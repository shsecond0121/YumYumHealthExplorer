...
[Releases](../../releases) 페이지에서 최신 `YumYumHealthExplorer_v1.0.exe`를 다운로드 → 더블클릭.

#### 다운로드 경고가 뜨면 (Edge/Chrome)
> "일반적으로 다운로드되지 않습니다" 빨간 경고

1. 다운로드 알림이나 브라우저 다운로드 패널에서 파일 옆 **▾** 또는 **⋯** 클릭
2. **"유지" (Keep)** 선택
3. 추가 확인 시 **"앱 보관"** 또는 **"그래도 보관"** 클릭

#### 실행 경고가 뜨면 (Windows SmartScreen)
> 파란색 "Windows의 PC 보호" 창

1. 작게 적힌 **"추가 정보"** 클릭
2. 아래에 나타나는 **"실행"** 버튼 클릭

> 💡 미서명 앱이라 발생하는 정상적인 경고입니다. 학교 프로젝트라 유료 코드 서명 증명서를 사용하지 않았으며, 보안 위협은 없습니다.
